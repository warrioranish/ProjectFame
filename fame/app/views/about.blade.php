			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-5 col-md-5 col-xs-12 col-sm-12 right_side">
						<img class="img-responsive" src="assets/images/about/1.jpg" alt="image">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-3">
						<div class="single-advisor">
							<div class="img-holder">
								<img src="assets/images/8.jpg" alt="Awesome Image"/>
								<div class="overlay">
									<div class="inner">
										<ul class="social">
					...
					<div class="col-md-3">
						<div class="single-advisor">
							<div class="img-holder">
								<img src="assets/images/9.jpg" alt="Awesome Image"/>
								<div class="overlay">
									<div class="inner">
										<ul class="social">
											<li><a href="#"><i class="fa fa-facebook"></i></a></li>
					...
					<div class="col-md-3">
						<div class="single-advisor">
							<div class="img-holder">
								<img src="assets/images/10.jpg" alt="Awesome Image"/>
								<div class="overlay">
									<div class="inner">
										<ul class="social">
											<li><a href="#"><i class="fa fa-facebook"></i></a></li>
					...
					<div class="col-md-3">
						<div class="single-advisor">
							<div class="img-holder">
								<img src="assets/images/11.jpg" alt="Awesome Image"/>
								<div class="overlay">
									<div class="inner">
										<ul class="social">
											<li><a href="#"><i class="fa fa-facebook"></i></a></li>
...
<!-- ==========Value Of our Company ======= -->
		<section class="company_value_sec">
			<div class="company_value_opacity">
				<div class="container">
					<div class="company_value_heading">
						<div class="title-box">
							<h2>Value of our <br>Company</h2>
						</div>
						<div class="text-box">
							<p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occae- cat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
						</div>
					</div> <!-- End Row -->
					<div class="row value_fact">
